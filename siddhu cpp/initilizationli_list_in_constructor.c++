...
class test{
  ...
  //  test(int i ,int j) : a(i),  b(a / j)
    // test(int i ,int j) : a(i),  b(a * j)
   // test(int i ,int j) : b(i) , a(i* j)      // order should be change her so it give the grbage value
   ...
   // test(int i ,int j) : b(i) , a(i* j)  // now we chane the position of a and b it should be run
    ...
    {  b = j;  //  it should be rum or we can decleare the value of a and be  bothe in body
