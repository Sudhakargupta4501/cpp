...
class calci
    ...
    friend int calci :: sumcomcalci(complex o1,complex o2);
     ...
     public:
		 ...
		 void displaydata(){
		  ...
		  int main(){
		  	...
		  	o2.setdata(4,6);
              calci cal;
             int res1  = cal.sumcalci(o1,o2);
              cout<<"the sum of the part of the class"<<res1<<endl;
			 
             int res = cal.sumcomcalci(o1,o2);
